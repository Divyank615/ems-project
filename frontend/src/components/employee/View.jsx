...
<div className="max-w-3xl mx-auto mt-10 bg-white p-8 py-12 rounded-lg shadow-lg border border-gray-200 min-h-[500px] border-l-8 border-teal-600">
  <h2 className="text-3xl font-semibold mb-10 text-center text-gray-800 tracking-wide">
    Employee Details
  </h2>
